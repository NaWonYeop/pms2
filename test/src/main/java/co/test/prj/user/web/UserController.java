...
public class UserController {
	...
	public String checkMypage(UserVO user, HttpSession session) {
		user = userDao.checkPwd(user);

		if (user != null) {
			session.setAttribute("user_pwd", user.getUser_pwd());
		} else {
			return "user/checkMypage";
		}
		return "home/home";
	}
	...
	public String Withdrawal(UserVO user, HttpSession session) {
		user = userDao.checkPwd(user);
