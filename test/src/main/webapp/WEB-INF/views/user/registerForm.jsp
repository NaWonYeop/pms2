		...
		<form action="register" onsubmit="return formCheck()" method="post">
			...
			<div class="card-body">
				<c:choose>
					<c:when test="${user_email ne null}">
						<input type="text" name="user_email" id="user_email"
							disabled="disabled" class="form-control col-8 "
							pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,16}$"
							title="이메일주소에 @가 없습니다" style="display: inline-block;"
							placeholder="아이디" autofocus required value="${user_email}">
					</c:when>
				...
				<input type="password" name="pw1" id="pw1" class="form-control"
					placeholder="비밀번호 확인" required><br> <input type="text"
					name="user_name" id="user_name" class="form-control"
					placeholder="이름" required> ​ 
					<input type="text"
					name="user_tel" id="user_tel" class="form-control"
					 required
					pattern="^[0-9]+$" maxlength="13" placeholder="예) 010-1234-5678"><br>
